...
send(msg.chat_id_, msg.id_,'☆:لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n ☆:˹آشــترڪ ههہنا- ༄ ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
Text = '\n☆:تفعيل البوت الخدمي 𓆰' 
else
Text = '\n☆:تتفعيل البوت الخدمي 𓆰'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,'☆:تم حفض ڪݪيشـههہ آݪســتآر 𓆰')
database:del(bot_id..'Start:Bots') 
return false
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'☆:لايوجد مشـــترڪين وهہميين فــي آݪبـــــوت𓆰\n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'☆:عدد المشتركين الان » ( '..#pv..' )\n☆:𓆰تم آزًآݪةً » ( '..sendok..' ) من المشتركين\n☆: الان عدد المشتركين الحقيقي » ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
BRAND = '\n☆:𓆰تم آزًآݪةً » { '..q..' } كروبات من البوت'
end
if w == 0 then
BRANDk = ''
else
BRANDk = '\n☆:𓆰تم آزًآݪةً » {'..w..'} كروب لان البوت عضو'
end
...
send(msg.chat_id_, msg.id_,'☆:𓆰تم آزًآݪةً جميع الاوامر المضافه')  
end
end
...
Reply_Status(msg,result.sender_user_id_,"reply","☆:تم تنزًيݪهمن المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BRAND, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","☆:تم تنزًيݪهمن المطور ثانويين")  
else
send(msg.chat_id_, msg.id_,"☆:لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","☆:تم تنزًيݪهمن المطور ثانويين")  
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☆: العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'WviivW')..')'
status  = '\n☆: الايدي » '..result.sender_user_id_..'\n☆: تم تنزًيݪهادمن من الكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_, msg.id_,'☆:𓆰تم آزًآݪةً صورة الكروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,'☆:𓆰تم آزًآݪةً ترحيب الكروب') 
end
end
...
send(msg.chat_id_, msg.id_, '☆:𓆰تم آزًآݪةً كليشة الايدي')
end
return false  
end 
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, "☆:ݪا توُجـدِ بـوُتات فــي اݪڪࢪوُب- ༄ ")
else
local t = '☆:عدد البوتات هنا >> {'..c..'}\n☆:عدٰدٰ اݪبـوُتات اݪتي هي ادِمـٰن - ༄ >> {'..x..'}\n☆:تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
local f = '☆:عدٰدٰ اݪبـوُتات اݪتي هي ادِمـٰن - ༄ >> {'..t..'}\n☆:ملاحضه علامة ال ( ☆:) تعني ان البوت ادمن \n'
...
if Mod(msg) then
send(msg.chat_id_, msg.id_,"☆:𓆰تم آزًآݪةً قوانين الكروب")  
...
if text == 'تم اݪامـٰࢪ بـنجـاح- ༄ ' and msg.reply_to_message_id_ == 0 and Mod(msg) then 
...
send(msg.chat_id_, msg.id_,'☆:𓆰تم آزًآݪةً الرد العام')
...
send(msg.chat_id_, msg.id_,'☆:𓆰تم آزًآݪةً الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'☆: ݪا يوُجـدِ ڪࢪوُبـات وُهمـٰيه فــي اݪبـوُت𓆰\n')   
else
local BRAND = (w + q)
local sendok = #group - BRAND
if q == 0 then
...
send(msg.chat_id_, msg.id_, '☆: اࢪســـݪ ݪي عـۂدِدِ اݪࢪســائݪ اݪان𓄂') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '☆:اࢪســݪ ݪي عۂدِدِ اݪنقٰـًاطُ اݪتي تࢪيدِ اضفـتها𓄂') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
* ☆:م7 ⏎اوامر التحشيش  - ༄*
* ☆:م8 ⏎اوامر مطور ألبوت  - ༄*
* ☆:م9 ⏎اوامر مطور الأساسي  - ༄* 
* ☆:م10 ⏎اوامر الأعضاء  - ༄*
𓍹ⵧⵧⵧⵧⵧ×𓀎×ⵧⵧⵧⵧⵧ𓍻
  𓀎 .[˹B𝘳ꪖꪀD Tꫀꪖꪑ˼](t.me/CXRCX) 𓀎 
]]
...
send(msg.chat_id_, msg.id_, '☆:تم تفــعۂيݪ اݪࢪدِوُدِ - ༄')
database:del(bot_id..'lock:add'..msg.chat_id_)
end
if text == 'تعطيل الردود' and Manager(msg) then  
send(msg.chat_id_, msg.id_, '☆:تم تعـۂطُيݪ اݪࢪدِوُدِ - ༄')
...
send(msg.chat_id_, msg.id_, t..'ٴ ☆:𓍹ⵧⵧⵧⵧⵧ×𓀎×ⵧⵧⵧⵧⵧ𓍻 ☆:○ٴ\n☆:彡 .[𝘽??𝘼??𝘿 𝙏𝙀𝘼𝙈](t.me/CXRCX)➢ ')
end
