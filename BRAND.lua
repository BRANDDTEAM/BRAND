...
sudo_users = {SUDO,1566031059,1503514782}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇BrAnD.")  
...
-------------
if text == "حصريات و تحديثات براند" and DevSoFi(msg) then
local updatech =[[
...
{
{text = 'BrAnD ChAnNeL', url="t.me/CXRCX"},
},
}
local msg_id = msg.id_/2097152/0.5
