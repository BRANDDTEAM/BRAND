...
database:set(bot_id.."VVVZVV:Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
database:sadd(bot_id.."VVVZVV:List:Cmd:Group:New"..msg.chat_id_,"ا")
database:set(bot_id.."VVVZVV:Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
database:sadd(bot_id.."VVVZVV:List:Cmd:Group:New"..msg.chat_id_,"م")
database:set(bot_id.."VVVZVV:Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
database:sadd(bot_id.."VVVZVV:List:Cmd:Group:New"..msg.chat_id_,"اد")
database:set(bot_id.."VVVZVV:Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
database:sadd(bot_id.."VVVZVV:List:Cmd:Group:New"..msg.chat_id_,"مد")
database:set(bot_id.."VVVZVV:Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
database:sadd(bot_id.."VVVZVV:List:Cmd:Group:New"..msg.chat_id_,"من")
database:set(bot_id.."VVVZVV:Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
database:sadd(bot_id.."VVVZVV:List:Cmd:Group:New"..msg.chat_id_,"اس")
database:set(bot_id.."VVVZVV:Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
database:sadd(bot_id.."VVVZVV:List:Cmd:Group:New"..msg.chat_id_,"تعط")
database:set(bot_id.."VVVZVV:Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
database:sadd(bot_id.."VVVZVV:List:Cmd:Group:New"..msg.chat_id_,"تفع")
