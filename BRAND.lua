...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-BrAnD/Files_BrAnD/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/SRC-BrAnD/BrAnD/main/BrAnD.lua')
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-BrAnD/Files_BrAnD/main/getfile.json")
if res == 200 then
