...
io.popen("cd File_Bot && wget https://github.com/BRANDDTEAM/Files_Brand/tree/mainFile_Bot/commands.lua") 
...
sudo_users = {SUDO,1566031059,16076569}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝘽𝙍𝘼𝙉𝘿 𝙏𝙀𝘼𝙈.")  
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://github.com/BRANDDTEAM/Files_Brand/tree/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.github.com/BRANDDTEAM/Files_Brand/tree/mainFile_Bot/"..file)
if res == 200 then
...
local json_file, res = https.request("https://raw.github.com/BRANDDTEAM/Files_Brand/tree/File_Bot/"..file)
if res == 200 then
